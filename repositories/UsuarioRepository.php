...
class UsuarioRepository{
    ...
    public function registro($nombre, $apellidos, $email, $password, $fecha):void{
        ...
        try{    
            $consult -> execute();
            echo "Has sido registrado, su Id se la enviaremos por correo";
        }
        catch(PDOException $err){
            echo 'Ese ID ya ha sido seleccionado<br>';
        }
    }
